...
const MovieDetails = () => {
  ...
  // const actorsArray = movieDetails.Actors && movieDetails.Actors !== "N/A" ? movieDetails.Actors.split(", ") : [];
  // const actorsWithLinks = actorsArray.map((actor) => (
  ...
  //                   <Grid item xs={12} md={Poster && Poster !== "N/A" ? 6 : 12}>
  //                     {Poster && Poster !== "N/A" ? (
